public class Teste {
    ...
    public static void main(String arg[]){
        ...
        // Pai 1 está usando o construtor default da classe
        Pai pai1 = new Pai();
        pai1.setRgPai(0);
        ...
        // Pai 2 está usando o construtor com 2 parâmetros da classe
        Pai pai2 = new Pai(11, "Pai 2");

        // Pai 3 está usando o construtor que recebe os
        // parâmetros do Pai e do Filho
        Pai pai3 = new Pai(22, "Pai 3", 2, "Filho 3");

        // Usando o toString para imprimir o objeto
        // Ver a sobrescrita do método
        pai1.toString();
