...
public class FuncionarioService {
    ...
    public void aumentarSalario(int porcentagem) {
        funcionarioRepository.aumentarSalario(porcentagem);
    }
    ...
    public List<Funcionario> findFuncionariosSemDependentes(Long departamentoId) {
        return funcionarioRepository.findFuncionariosSemDependentes(departamentoId);
    }
    ...
    @Transactional
    public void atualizarDepartamento(Long antigoDepartamentoId, Long novoDepartamentoId) {
        funcionarioRepository.atualizarDepartamento(antigoDepartamentoId, novoDepartamentoId);
    }
    ...
    @Transactional
    public void deletarFuncionariosPorDepartamento(Long departamentoId) {
        funcionarioRepository.deletarFuncionariosPorDepartamento(departamentoId);
    }
