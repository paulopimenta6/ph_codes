package com.paulopimenta.springboot_greendogdelivery.dto;
...
public class RespostaDTO {
    ...
    public int hashCode() {
        ...
        result = prime*result+( (mensagem==null) ? 0 : pedido.hashCode() );
        result = prime*result+( (mensagem==null) ? 0 : getValorTotal().hashCode() );
        return result;
    }
