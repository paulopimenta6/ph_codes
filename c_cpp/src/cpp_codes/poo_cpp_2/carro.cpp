...
Carro::Carro(){
	...
	this->cor = "Azul";
	totalCarros++;
	cout << "Metodo construtor chamado. ";
	cout << "Nenhum modelo configurado, este sera um fusca" << endl;
}
...
Carro::Carro(string modelo, int ano, float preco, string cor){
	...
	this->cor = cor;
	totalCarros++;
	cout << "Metodo construtor de carro " << this->modelo << endl;
}

Carro::~Carro(){
	totalCarros--;
	   cout << "Metodo destrutor chamado para o carro " << this->modelo << endl;
}
