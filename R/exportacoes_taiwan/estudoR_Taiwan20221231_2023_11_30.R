  ...
  countries <- c()
  types <- c()
  period <- data.frame(Month = taiwan_data[[2]][3:15]) 
  ...
  #USA
  ggplot(data = DF_USA) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to USA 2022 - 2023", 
  ...
  ggplot(data = DF_Japan) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to Japan 2022 - 2023", 
         y ="Value in Millions of US Dollars", 
         x = "Month",
         caption = "Source = MOEA") +
    guides(fill = guide_legend(title = "Value"))
  ...
  ggplot(data = DF_HKCN) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to HK and CN 2022 - 2023", 
         y ="Value in Millions of US Dollars", 
         x = "Month",
         caption = "Source = MOEA") +
    guides(fill = guide_legend(title = "Value"))
  ...
  ggplot(data = DF_EU) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to Europe 2022 - 2023", 
         y ="Value in Millions of US Dollars", 
         x = "Month",
         caption = "Source = MOEA") +
    guides(fill = guide_legend(title = "Value"))
  ...
  ggplot(data = DF_ASEAN) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to ASEAN 2022 - 2023", 
         y ="Value in Millions of US Dollars", 
         x = "Month",
         caption = "Source = MOEA") +
    guides(fill = guide_legend(title = "Value"))
  ...
  ggplot(data = DF_OTHERS) + 
    geom_bar(mapping = aes(x = Month, y = `Electronic Products`, fill = `Electronic Products`), stat = "identity") +
    labs(title = "Taiwanese exports to OTHERS 2022 - 2023", 
         y ="Value in Millions of US Dollars", 
         x = "Month",
         caption = "Source = MOEA") +
    guides(fill = guide_legend(title = "Value"))