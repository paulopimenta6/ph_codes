...
#Onda 1
ggplot(data = fazUsoContinuoIndometacinaOnda1, aes(x = as.factor(fazUsoContinuoIndometacinaOnda1Ajustada), fill=as.factor(idadeNaOnda1Ajustada))) + 
  geom_bar() +
  ggtitle("Faz uso Indometacina - Onda 1") +
  labs(fill = "Idade - Onda 1", y = "Quantidade de pessoas", x = "0: Não, 1: Sim")

#Onda 2
ggplot(data = fazUsoContinuoIndometacinaOnda2, aes(x = factor(fazUsoContinuoIndometacinaOnda2Ajustada), fill=as.factor(idadeNaOnda2Ajustada))) + 
  geom_bar() +
  ggtitle("Faz uso Indometacina - Onda 2") +
  labs(fill = "Idade - Onda 1", y = "Quantidade de pessoas", x = "0: Não, 1: Sim")

#Onda 3
ggplot(data = fazUsoContinuoIndometacinaOnda3, aes(x = factor(fazUsoContinuoIndometacinaOnda3Ajustada), fill=as.factor(idadeNaOnda3Ajustada))) + 
  geom_bar() +
...
################################################################################
###Onda 1
ggplot(data = fazUsoContinuoIndometacinaOnda1, aes(y = idadeNaOnda1Ajustada, x = factor(fazUsoContinuoIndometacinaOnda1Ajustada))) +
...
###Onda 2
ggplot(data = fazUsoContinuoIndometacinaOnda2, aes(y = idadeNaOnda2Ajustada, x = factor(fazUsoContinuoIndometacinaOnda2Ajustada))) +
...
###Onda 3
ggplot(data = fazUsoContinuoIndometacinaOnda3, aes(y = idadeNaOnda3Ajustada, x = factor(fazUsoContinuoIndometacinaOnda3Ajustada))) +
