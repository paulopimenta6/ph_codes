...
#gfortran -o rline_out.out Fill_Met.o Translate_Rotate.o Compute_File_Size.o Sigmay.o Line_Source_Data.o RLINE_Main.o Meander.o Compute_Met.o Numerical_Line_Source.o Analytical_Line_Source.o Analytical_Line_Parallel.o Point_Conc.o Polyinterp.o Read_Line_Source_Inputs.o Read_Met_Inputs.o Read_Receptors.o Read_Sources.o Data_Structures.o Sigmaz.o Write_Hourly_All.o Write_Daily_Ave.o Write_Hourly_by_Month.o MOST_Wind.o Effective_Wind.o Create_Exp_Table.o Expx.o Barrier_Displacement.o Depressed_Displacement.o Deallocate_arrays.o
gfortran -o RLINEv1_2_gfortran.exe Fill_Met.o Translate_Rotate.o Compute_File_Size.o Sigmay.o Line_Source_Data.o RLINE_Main.o Meander.o Compute_Met.o Numerical_Line_Source.o Analytical_Line_Source.o Analytical_Line_Parallel.o Point_Conc.o Polyinterp.o Read_Line_Source_Inputs.o Read_Met_Inputs.o Read_Receptors.o Read_Sources.o Data_Structures.o Sigmaz.o Write_Hourly_All.o Write_Daily_Ave.o Write_Hourly_by_Month.o MOST_Wind.o Effective_Wind.o Create_Exp_Table.o Expx.o Barrier_Displacement.o Depressed_Displacement.o Deallocate_arrays.o
